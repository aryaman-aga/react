...
function Card({username , btntext = "Subscribe"}) {
  ...
  return (
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group mb-5">
      ...
      <div className="flex items-center justify-between">
        <button className="px-4 py-2 bg-white hover:bg-blue-200 text-white text-sm rounded-lg transition-colors duration-1000">
          {btntext || "Subscribe"}
        </button>
